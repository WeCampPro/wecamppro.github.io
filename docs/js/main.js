(function ($) {
	...
	if($('.it-menu-content').length && $('.it-menu-mobile').length){
		...
		arrow.each(function () {
			...
			arrowBtn.innerHTML = "<i class='fal fa-angle-left'></i>";
	...
	$('.it-testimonial-slide-nav-active').slick({
		prevArrow: '<button type="button" class="slick-prev"><i class="far fa-long-arrow-alt-right"></i></button>',
		nextArrow: '<button type="button" class="slick-next"><i class="far fa-long-arrow-alt-left"></i></button>',
